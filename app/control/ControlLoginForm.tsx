...
export default function ControlLoginForm() {
  ...
  const login = async () => {
    ...
    // Use a full page navigation so the browser sends the fresh session
    // cookie to the server component, bypassing any stale Next.js RSC cache
    // that was built before login (which had no cookie and would redirect back).
