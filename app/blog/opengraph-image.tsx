        ...
        <div style={{ position: "relative", zIndex: 10, display: "flex", flexDirection: "column", justifyContent: "space-between", padding: "48px 56px", width: portraitSrc ? 760 : "100%", height: "100%" }}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 7, background: `${SECONDARY}18`, border: `1px solid ${SECONDARY}44`, borderRadius: 100, padding: "5px 13px" }}>
              ...
              <span style={{ color: SECONDARY, fontSize: 12, fontWeight: 700, letterSpacing: 1.8 }}>BLOG</span>
            </div>
          </div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
            ...
            <div style={{ color: FG, fontSize: 80, fontWeight: 800, lineHeight: 1.0, letterSpacing: -2 }}>The Blog.</div>
            <div style={{ color: MUTED_FG, fontSize: 21, lineHeight: 1.55 }}>Dev logs, structured learning series, and interactive articles.</div>
          </div>

          <div style={{ display: "flex", alignItems: "center", gap: 10, borderTop: `1px solid ${BORDER}`, paddingTop: 18 }}>
            <span style={{ color: MUTED_FG, fontSize: 15 }}>Written by</span>
            <span style={{ color: FG, fontSize: 15, fontWeight: 600 }}>Victor Nabasu</span>
          </div>
        </div>
      </div>
    ),
