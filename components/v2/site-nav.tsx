    ...
    >
      <div className="grid grid-cols-2 items-center px-4 py-4 md:grid-cols-3 md:px-6 md:py-[1.15rem]">
        ...
        <div className="flex items-center justify-self-end gap-2 sm:gap-3">
          <ModeToggle />
          <a href={sectionHref("#contact")} className="hidden items-center bg-primary px-4 py-2.5 font-mono text-xs uppercase tracking-[0.12em] text-primary-foreground md:inline-flex">
